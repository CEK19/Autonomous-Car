...
cnn = load_model("D:/container/AI_DCLV/3-4/Model-15_RAS1-0.hdf5",custom_objects={'focal_tversky':focal_tversky, 'dice':dice})

dataX = []
dataY = []

nameList = os.listdir("D:/container/AI_DCLV/readData/imageSet/stdDataset/image/")

print("Start read data")

for eachName in nameList:
    print(eachName)
    tmpX = cv2.imread("D:/container/AI_DCLV/readData/imageSet/stdDataset/image/" + eachName)
    ...
    tmpY = cv2.imread("D:/container/AI_DCLV/readData/imageSet/stdDataset/label/" + eachName)
...
for i in range(1,16):
    ...
    for j in range(8096):
        ...
        dataX.append(augment_image(org_dataX[idx]))
    ...
    dataY /= 255
    print(" Start train !")
    history = cnn.fit(dataX, dataY, batch_size = 4, epochs = 3)
    # cnn.save("D:/container/AI_DCLV/last/Model-CARLA10_last.hdf5")
    # if i%10 == 0:
    cnn.save("D:/container/AI_DCLV/3-4/Model-16_RAS-"+str(i)+".hdf5")
