...
orgImgPath = "D:/container/AI_DCLV/readData/output/fullOutput/image/"
labelImgPath = "D:/container/AI_DCLV/readData/output/fullOutput/image/"
...
file = open(timeCompare + "nhan-time.txt", 'w')
