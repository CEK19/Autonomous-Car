...
for tryTime in range(1000):
    ...
    # print("end", end)
    startTime = time.time()
    finder2 = IDAStarFinder(diagonal_movement=DiagonalMovement.always)
...
print("=====>", np.min(time_arr), np.max(time_arr), np.mean(time_arr))
# print(path)
